...
|---|---|---|---|---|---|---|---|
| ❌ | `@linxin666/dsh-web-ui-all` | [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | Web UI suite (task board, git graph, pet, skins, live stats) | 0.3.3 | 20 | 15 bundle(s) | console errors: [plugin-manager] plugin-manager: cannot determine the boot profile; pass --profile <name> or set DSH_PROFILE \| [plugin-manager] plugin-manager: |
| ✅ | `dsh-better-sidebar` | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | sidebar workbench: file editor, terminal, git, subagents | 0.16.0 | 1 | 1 bundle(s) |  |
| ✅ | `@anionex/dsh-vision-toolkit` | [Anionex/dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | vision tools for text-only models | 0.1.38 | 1 | — | no browser half materialized |
| ✅ | `@liustack/modlens` | [liustack/modlens](https://github.com/liustack/modlens) | vision bridge plugin | 3.24.2 | 1 | 1 bundle(s) |  |
| ✅ | `dshmarket` | [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) | in-app plugin marketplace | 1.26.0 | 1 | — | no browser half materialized |
| ✅ | `@nanmicoder/dsh-agent-teams` | [NanmiCoder/dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | agent teams | 0.1.13 | 1 | 1 bundle(s) |  |
| ✅ | `dsh-working-activity` | [ccch1mneyyy/working-activity](https://github.com/ccch1mneyyy/working-activity) | working-line activity indicator | 0.3.3 | 1 | 1 bundle(s) |  |
...
| ✅ | `@linxin666/dsh-client-ui-task-board` | [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | task board panel | 0.3.3 | 1 | 1 bundle(s) |  |
| ✅ | `@linxin666/dsh-client-ui-git-graph` | [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | git graph panel | 0.3.3 | 1 | 1 bundle(s) |  |
| ✅ | `@linxin666/dsh-pet` | [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | desktop pet | 0.3.3 | 1 | 1 bundle(s) |  |
...
| ✅ | `@linxin666/dsh-client-ui-skin-center` | [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | skin centre | 0.3.3 | 1 | — | no browser half materialized |
...
| ❌ | `@deepseek-harness-tui/dsh-tui` | [ccch1mneyyy/dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | terminal UI surface, written for the headless profile | 0.9.0 | 0 | — | boot failed: Error: dsh-tui: root.registry.values is unavailable from a plugin activation Recovery from the failure screen restored the app. |
